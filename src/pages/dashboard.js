  ...
  return `<main class="ml-64 mt-16 p-8 min-h-screen page-enter">
    <div class="mb-8 flex justify-between items-end">
      ...
      <div class="flex gap-2">
        <input id="dash-crop" type="text" placeholder="Crop (e.g. Wheat)" value="${userPrefs.crop || ''}" class="px-4 py-2 bg-surface-container-low border-none rounded-xl text-sm font-semibold text-primary focus:ring-2 focus:ring-primary/20 w-32">
...
function extractTemperature(text) {
  ...
  if (m) {
    ...
    if (t > 50) return `${Math.round((t - 32) * 5/9)}°C`;
